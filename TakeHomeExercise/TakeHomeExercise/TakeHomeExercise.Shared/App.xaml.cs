...
namespace TakeHomeExercise
{
   ...
   public sealed partial class App : Application
   {
      ...
      {
         if( args is Windows.ApplicationModel.Activation.WebAuthenticationBrokerContinuationEventArgs )
         {
            if( AppActivatedEvent != null )
               AppActivatedEvent( this, ( Windows.ApplicationModel.Activation.WebAuthenticationBrokerContinuationEventArgs )args );
         }
